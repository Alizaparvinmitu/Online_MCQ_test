...
{
echo "<h2 class='text-center bg-danger'>Welcome to Online  Competitive Exam based MCQ Practice system</h2>";
		echo '<table width="28%"  border="0" align="center">
  <tr>
    <td width="7%" height="65" valign="bottom"><img src="image/HLPBUTT2.JPG" width="50" height="50" align="middle"></td>
    <td width="93%" valign="bottom" bordercolor="#0000FF"> <a href="sublist.php" class="style4">Subject for MCQ Test </a></td>
  </tr>
  <tr>
...
<table width="100%" border="0">
  ...
  <tr>
    <td height="290" valign="top"><div align="center">
...
<p align="left" class="style5">&nbsp;</p>
      <blockquote>
          <p1 align="left" class="style5"><span class="style7">There are a lot of competitive based examination in now a days .This Site will provide the MCQ for various subject based on the Competitive Exam of interest. 
            You need to login for the take the online exam.this will help you to developing your performance</span></p1>
      </blockquote>
    </div></td>
    		<table align="center" border="0" WIDTH="50%" height="240">
			<h3 class="text-center bg-warning">LOGIN PAGE</h3>
        ...
        <a class="btn btn-success " href="signup.php">if you are New user ? Please  click here</a></th>
      </table>
      <div align="center">
